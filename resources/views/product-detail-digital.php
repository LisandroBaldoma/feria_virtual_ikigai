...
<html lang="es"><head><meta charset="utf-8"/><meta content="width=device-width, initial-scale=1.0" name="viewport"/><link href="https://fonts.googleapis.com" rel="preconnect"/><link crossorigin="" href="https://fonts.gstatic.com" rel="preconnect"/><link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700&amp;family=Noto+Serif:ital,wght@0,400;0,500;0,600;0,700;1,400;1,600&amp;family=Public+Sans:wght@500;600;700&amp;display=swap" rel="stylesheet"/><link href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:wght,FILL@100..700,0..1&amp;display=swap" rel="stylesheet"/>
<link href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:wght,FILL@100..700,0..1&amp;display=swap" rel="stylesheet"/><style>@layer base{html,body{margin:0;padding:0;}body{overscroll-behavior:none;}main>:first-child{margin-top:0!important;}main>:last-child{margin-bottom:0!important;}}::-webkit-scrollbar{display:none;}</style><script src="https://cdn.tailwindcss.com?plugins=forms,container-queries"></script><script id="tailwind-config">tailwind.config={darkMode:"class",theme:{extend:{"colors":{"on-tertiary-container":"#4a3f00","on-error-container":"#93000a","tertiary-fixed":"#f9e37a","outline-variant":"#c3c6d5","on-primary":"#ffffff","on-secondary-container":"#606569","on-surface-variant":"#434653","inverse-primary":"#b1c5ff","on-primary-container":"#e7ebff","tertiary-container":"#bfab49","primary":"#094cb2","surface-container-lowest":"#ffffff","on-primary-fixed-variant":"#00419d","surface-container":"#efedee","on-tertiary-fixed-variant":"#524600","surface-container-low":"#f5f3f4","surface-tint":"#2259bf","on-secondary-fixed":"#171c20","on-secondary":"#ffffff","secondary-fixed":"#dfe3e8","primary-fixed":"#d9e2ff","primary-container":"#3366cc","error":"#ba1a1a","secondary-container":"#dfe3e8","on-tertiary":"#ffffff","on-tertiary-fixed":"#211b00","surface":"#faf9fa","secondary-fixed-dim":"#c2c7cc","on-surface":"#1b1c1d","tertiary":"#6d5e00","error-container":"#ffdad6","primary-fixed-dim":"#b1c5ff","on-secondary-fixed-variant":"#42474b","inverse-on-surface":"#f2f0f1","surface-container-highest":"#e3e2e3","surface-dim":"#dbdadb","on-background":"#1b1c1d","tertiary-fixed-dim":"#dcc661","surface-container-high":"#e9e8e9","on-error":"#ffffff","secondary":"#5a5f63","outline":"#737784","surface-variant":"#e3e2e3","background":"#faf9fa","inverse-surface":"#303031","surface-bright":"#faf9fa","on-primary-fixed":"#001946"},"borderRadius":{"DEFAULT":"0.125rem","lg":"0.25rem","xl":"0.5rem","full":"0.75rem"},"spacing":{"space-lg":"1.5rem","margin-mobile":"1.25rem","margin":"3rem","space-xl":"2.5rem","gutter-mobile":"1rem","space-sm":"0.5rem","gutter":"1.5rem","space-md":"1rem","space-xs":"0.25rem"},"fontFamily":{"headline":["Noto Serif","serif"],"display":["Noto Serif","serif"],"body":["Inter","sans-serif"],"label":["Public Sans","sans-serif"]}}}}</script><meta content="web_standard" name="shell-type"/></head><body class="bg-background font-body text-[15px] leading-[24px] text-on-surface antialiased"><header class="fixed top-0 left-0 right-0 w-full z-50 bg-surface/95 backdrop-blur-xl border-b border-outline-variant/30 shadow-[0_1px_8px_rgba(0,0,0,0.03)]"><div class="h-20 max-w-7xl mx-auto px-6 lg:px-12 flex items-center justify-between gap-gutter"><div class="flex items-center gap-space-sm"><a class="flex items-center gap-space-sm group" data-path="recorrer-feria" href="#"><img alt="Ikigai Logo" class="h-8 w-auto object-contain" src="https://lh3.googleusercontent.com/aida/AEtjO1Uc4Cj-7Oyk3C7zlDGLW-hPWmOWLcvCK6KLKBlN0r4_NK1lVEsMw8Lj8RNfmpM-q5sXvs8agc2iUEzC17emXqASh-uJls0kejzel784NTEqBAOONz_NKKtD6CPSMsqPCaljzYSLCgmqGZHMMznGtn6pyX8lmDD84qSs3xZWOKirq-Y51kR0kU-aZur1xCl7j1Qyd1fg2ns-mviovMHuLSLepKnfTVRmyvei9tRFfP1VwNjnoQhpNp-Rep0"/><span class="font-headline font-medium text-[22px] leading-[30px] text-on-surface tracking-tight group-hover:text-primary-container transition-colors">Feria Ikigai</span></a></div><nav class="hidden md:flex items-center gap-space-md lg:gap-space-lg" data-active-classes="bg-surface-container text-primary-container font-semibold"><a class="px-space-sm py-space-xs rounded-lg font-body font-medium text-[15px] text-on-surface-variant hover:text-on-surface transition-colors" data-path="recorrer-feria" href="#">Recorrer Feria</a><a class="px-space-sm py-space-xs rounded-lg font-body font-medium text-[15px] text-on-surface-variant hover:text-on-surface transition-colors" data-path="stands-y-tiendas" href="#">Stands y Tiendas</a><a class="px-space-sm py-space-xs rounded-lg font-body font-medium text-[15px] text-on-surface-variant hover:text-on-surface transition-colors" data-path="categorias" href="#">Categorías</a><a class="px-space-sm py-space-xs rounded-lg font-body font-medium text-[15px] text-on-surface-variant hover:text-on-surface transition-colors" data-path="historias-de-creadores" href="#">Historias de Creadores</a></nav><div class="flex items-center gap-space-md"><a class="inline-flex items-center justify-center px-5 py-2.5 rounded-lg bg-primary-container hover:bg-primary text-on-primary font-body font-semibold text-[15px] shadow-[0_4px_14px_rgba(51,102,204,0.22)] hover:shadow-[0_6px_20px_rgba(9,76,178,0.3)] transition-all" data-path="abrir-mi-stand" href="#">Abrir mi Stand</a><a class="flex items-center rounded-full p-0.5 hover:ring-2 hover:ring-primary-container/50 transition-all" data-path="perfil-artesano" href="#"><img alt="Profile" class="w-8 h-8 rounded-full object-cover" src="https://lh3.googleusercontent.com/aida-public/AB6AXuCSkqBDdCwtmEUSTvSwtTMke6eIDU2789iiZ9a3qiNTkoY4R88-dFpmWbBx5vZBAI1cW-ojbaalIb4yK703bad1HS3ppMtPy8aRjHq2-HLp6_CSpbEjAzEl5bfpnRIrxqzhV009efyj8CL8hE1rb-62VBaaM0ROUUuKwmSOjdemc6T2G7PO7uc_AAzWlhnKvC4IA_oR_ytajF6HUosBgnDcwVXuiZoNOY0rgzVOUxJznyj4pp57sD_o_Q"/></a></div></div></header><main class="w-full pt-20 bg-background min-h-screen"><div class="flex flex-col w-full">
